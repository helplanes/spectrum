...
const shippinganddelivery: React.FC = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-black">
            ...
            <h2 className="text-2xl font-bold mb-4 text-gray-100">Shipping and Delivery Information</h2>
            ...
            Instead have this vadapav, fresh from the canteen (not really)
             ...
             <Image className="mx-auto pt-4" width="150" height="150" alt="image" src="https://i.imgur.com/qFeRgsS.png" /> 
        </div>
      </div>
    );
  };
