    ...
    return (
            <div className="p-4 lg:p-8">
                ...
                <div className="h-full w-full bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]                  ">
                        ...
                        <div className="container px-6 py-20 mx-auto">
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <a target="_blank" href="https://www.linkedin.com/in/ritika-jadhav-a894ba274" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                        ...
                                        <a target="_blank" href="https://www.instagram.com/ritikajadhav02" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                               ...
                               <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <a href="/" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                        ...
                                        <a href="/" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.linkedin.com/in/atharvaez" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/atharvez?igsh=MXU1YWRkbGllbTUwYQ" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.linkedin.com/in/shreeyash-patil-57a71a242" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/shreeyash_2708?igsh=YTQwcXpwN3k2amoz" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                        ...
                        <div className="container px-6 py-20 mx-auto">
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.instagram.com/kewonit/" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.instagram.com/mayank_kadam1039/" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                    ...
                    <section >
                        <div className="container px-6 py-20 mx-auto">
                            <h1 className="text-2xl font-semibold text-center  capitalize lg:text-3xl text-white mb-8">Design Team</h1>
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://in.linkedin.com/in/diya-kote-412331289" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/_.diya_14/" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                    ...
                    <section >
                        <div className="container px-6 py-20 mx-auto">
                            <h1 className="text-2xl font-semibold text-center  capitalize lg:text-3xl text-white mb-8">Registration Team</h1>
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.linkedin.com/in/abhiraj-hiwale-587676276" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/__abhiraj.sh/?igsh=ZGUzMzM3NWJiOQ" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                        ...
                        <div className="container px-6 py-20 mx-auto">
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.linkedin.com/in/ananya-rajankar-10a938264" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/an.anya_rajankar" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
                                ...
                                <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.instagram.com/x.____parth.____x" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                        <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                        </svg>
                                ...
                                <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.instagram.com/gangwal_preksha007" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                        <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                        </svg>
                    ...
                    <section >
                        <div className="container px-6 py-20 mx-auto">
                            <h1 className="text-2xl font-semibold text-center  capitalize lg:text-3xl text-white mb-8">Finance</h1>
                            ...
                            <div className="flex flex-wrap gap-8 justify-center items-center">
                                ...
                                <div className="flex flex-col bg-gray-900 items-center p-8 transition border duration-300 transform  animation:1s ease-in-out cursor-pointer rounded-xl  group  border-gray-700 hover:border-transparent min-h-[350px] shadow-lg shadow-indigo-500/20 min-w-[300px]              hover:scale-105   ">
                                    ...
                                    <div className="flex mt-3 -mx-2">
                                    <a target="_blank" href="https://www.linkedin.com/in/varda-gachake-42041528a" className="mx-2  text-gray-500  group-hover:text-white" aria-label="Reddit">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19,3H5C3.895,3,3,3.895,3,5v14c0,1.105,0.895,2,2,2h14c1.105,0,2-0.895,2-2V5C21,3.895,20.105,3,19,3z M9,17H6.477v-7H9 V17z M7.694,8.717c-0.771,0-1.286-0.514-1.286-1.2s0.514-1.2,1.371-1.2c0.771,0,1.286,0.514,1.286,1.2S8.551,8.717,7.694,8.717z M18,17h-2.442v-3.826c0-1.058-0.651-1.302-0.895-1.302s-1.058,0.163-1.058,1.302c0,0.163,0,3.826,0,3.826h-2.523v-7h2.523v0.977 C13.93,10.407,14.581,10,15.802,10C17.023,10,18,10.977,18,13.174V17z"></path>
                                            </svg>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/_varda.__/" className="mx-2 text-gray-500  group-hover:text-white" aria-label="Facebook">
                                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
                                            </svg>
